...
![Return curves across all vintages](rebuild/reports/fig1_return_curves_all_vintages.png)
...
![Policy comparison bar chart](rebuild/reports/fig3_bar_policy_comparison.png)
...
![Dollar uplift bars](rebuild/reports/fig6_dollar_uplift_bars.png)
...
> `EXPLORATORY_accept_reject_framing.ipynb` — the original lender framing tried first. Kept for transparency; not part of the main story. See `rebuild/RESEARCH_STORY.md` for why.
...
├── demo/                  # Interactive investor demo (live at loan-alpha.streamlit.app)
...
├── Makefile               # install, test, train, returns, portfolio, api, demo
...
make demo             # Streamlit investor demo at localhost:8501
make api              # FastAPI at localhost:8000/score
```

Full research journey, experiment history, and methodology decisions: **[`rebuild/RESEARCH_STORY.md`](rebuild/RESEARCH_STORY.md)**
